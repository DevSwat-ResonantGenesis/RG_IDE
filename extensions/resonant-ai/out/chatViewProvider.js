...
exports.ResonantChatViewProvider = void 0;
/*---------------------------------------------------------------------------------------------
...
class ResonantChatViewProvider {
    _context;
    _authService;
    _view;
    _conversationMessages = [];
    constructor(_context, _authService) {
        this._context = _context;
        this._authService = _authService;
        (0, toolExecutor_1.setGlobalState)(_context.globalState);
    }
    ...
    resolveWebviewView(webviewView, _context, _token) {
        ...
        (0, toolExecutor_1.setAskUserCallback)(async (question, options) => {
    ...
    async _handleUserMessage(text) {
        ...
        const maxLoops = config.get('maxToolLoops', 15);
        ...
        if (token) {
            (0, toolExecutor_1.setAuthInfo)(token, authDomain);
        }
        ...
        try {
            ...
            while (loops < maxLoops) {
                ...
                const executeOne = async (tc) => {
                    ...
                    const toolResult = await (0, toolExecutor_1.executeToolCall)(tc, workspaceRoot);
    ...
    async _callLLM(apiUrl, messages, token) {
        try {
